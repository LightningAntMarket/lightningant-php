...
class BuildLiteBehavior {
    public function run(&$params) {
        ...
        $content  .=  "\nnamespace { LAP\LAP::addMap(".var_export(\LAP\LAP::getMap(),true).");";
        $content  .=  "\nL(".var_export(L(),true).");\nC(".var_export(C(),true).');LAP\Hook::import('.var_export(\LAP\Hook::get(),true).');LAP\LAP::start();}';
