...
// 系统常量定义
defined('LAP_PATH')   or define('LAP_PATH',     __DIR__.'/');
...
defined('LIB_PATH')     or define('LIB_PATH',       realpath(LAP_PATH.'Library').'/'); // 系统核心类库目录
defined('CORE_PATH')    or define('CORE_PATH',      LIB_PATH.'LAP/'); // LAP类库目录
defined('BEHAVIOR_PATH')or define('BEHAVIOR_PATH',  LIB_PATH.'Behavior/'); // 行为类库目录
defined('MODE_PATH')    or define('MODE_PATH',      LAP_PATH.'Mode/'); // 系统应用模式目录
